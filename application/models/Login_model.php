...
class Login_model extends CI_Model {
    ...
    public function checkLogin($username, $password) {
        $this->db->select('user_login.user_id,user_login.user_role,user_login.is_active,user_info.full_name,user_role.permitted_page_code,user_role.permitted_action_code');
        ...
        if ($query->num_rows() == 1) {
            ...
            $data = array(
                ...
                'permittedActionCode' => $row->permitted_action_code,
                'validated' => true
            );
