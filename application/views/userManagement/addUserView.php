<script>
    function addUser() {
        if ($.trim($('#fullName').val()) === "" || $.trim($('#mobile').val()) === "" || $.trim($('#userRole').val()) === "" || $.trim($('#password').val()) === "") {
...
<div class="col-md-12 col-sm-12 col-xs-12 m-t-20">
    ...
    <form id="userAddForm" class="form-horizontal form-label-right" action="<?php echo base_url() ?>UserManagement/addUser" method="post">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Password <span class="danger">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="password" class="form-control col-md-7 col-xs-12" type="password" name="password">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Re-Type Password <span class="danger">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
