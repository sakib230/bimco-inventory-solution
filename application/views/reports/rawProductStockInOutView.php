...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="row">
        <form id="customizeForm" action="<?php echo base_url() ?>Reports/rawProductStockInOut" method="post">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="row">
                    <div class="form-group">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" >Raw Product</label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <table id="advanceFilterTable" class="hidden">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="text-center">
                    ...
                    <span class="font-20">Stock In & Out Report</span><br>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 m-t-30">
                <table class="table table-bordered custom-table" id="stockTable">
                    <tr>
                        ...
                        <th class='td-center'>Stock In</th>
                        <th class='td-center'>Stock Out</th>
                        <th class='td-center'>Raw Mixing</th>
...
<script>
    ...
    function loadData(noProductflag) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url() ?>Reports/getRawProductStockInOutData',
    ...
    function getProductTd(resultObj, i) {
        ...
        var particular = "";
        var stockInquantity = "";
        var stockOutquantity = "";
        var rawMixingQuantity = "";
        // var quantity = 0;
        var rate = 0;
        var amount = 0;
        ...
        if (resultObj.products[i].vendor) {
            vendorTitle = resultObj.products[i].vendor_name + ' <br>(' + resultObj.products[i].display_contact_id + ')';
        }
...
//        }
        ...
        if (stockVariantType === '<?php echo STOCK_VARIANT_MIXING ?>') {
            if (resultObj.products[i].stock_out_quantity) {
                rawMixingQuantity = resultObj.products[i].stock_out_quantity;
            }

            stockVariantTypeName = 'Raw Mixing';
        } else if (stockVariantType === '<?php echo STOCK_VARIANT_EXTRA_RAW ?>') {
            if (resultObj.products[i].stock_out_quantity) {
                stockOutquantity = resultObj.products[i].stock_out_quantity;
            }
        ...
        } else if (stockVariantType === '<?php echo STOCK_VARIANT_ADD_RAW ?>') {
            stockVariantTypeName = 'Stock In';
            stockInquantity = resultObj.products[i].stock_in_quantity;
        }
...
//                        <th class='td-center'>Amount<br><small><i class="text-muted">BDT</i></small></th>
        ...
        var html = "<td class='td-center'>" + stockDate + "</td>\n\
                    ...
                    <td class='td-right'>" + stockInquantity + "</td>\n\
                    <td class='td-right'>" + stockOutquantity + "</td>\n\
                    <td class='td-right'>" + rawMixingQuantity + "</td>\n\
