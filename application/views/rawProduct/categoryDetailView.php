    ...
    function deleteCategory(categoryCode) {
        swal({
            ...
            $.ajax({
                ...
                url: '<?php echo base_url() ?>RawProduct/deleteCategory',
                success: function (result) {
                    window.location.href = BASE_URL + "RawProduct/category?response=" + result;
                }
            });
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="float-right">
        <div class="btn-group  btn-group-sm">
            <a href="<?php echo base_url() ?>RawProduct/showEditCategory?categoryCode=<?php echo $categoryDetail[0]['category_code'] ?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-pencil font-15"></i></a>
...
<div class="col-md-12 col-sm-12 col-xs-12 m-t-20">
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <?php echo $categoryDetail[0]['display_category_id']; ?>
        </div>
    </div>
    <div class="row">
