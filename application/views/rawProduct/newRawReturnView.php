...
<div class="col-md-12 col-sm-12 col-xs-12 p-t-20">
    <form id="stockEntryForm" class="form-horizontal" action="<?php echo base_url() ?>RawProduct/addRawReturn" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="input-group dateTxt">
                        <input type="text" name="stockDate" id="stockDate" class="form-control">
        ...
        <div class="row">
            ...
            <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <button type="button" class="btn btn-success btn-sm" onclick="newStock()"><i class="fa fa-check"></i> Save</button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var rawProductTable = $('#rawProduct-datatable').DataTable({
            ...
            'serverMethod': 'post',
            "bDestroy": true,
            "ajax": '<?php echo base_url() ?>RawProduct/getProductForRawReturn',
            "deferRender": true,
            "paging": true,
    ...
    function newStock() {
        ...
        swal({
            ...
            $.ajax({
                ...
                url: BASE_URL + 'RawProduct/checkRawReturnQuantity',
