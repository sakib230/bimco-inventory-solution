    ...
    function deleteProduct(productCode) {
        swal({
            ...
            $.ajax({
                ...
                url: '<?php echo base_url() ?>RawProduct/deleteProduct',
                success: function (result) {
                    window.location.href = BASE_URL + "RawProduct/product?response=" + result;
                }
            });
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="float-right">
        <div class="btn-group  btn-group-sm">
            <a href="<?php echo base_url() ?>RawProduct/showEditProduct?productCode=<?php echo $productDetail[0]['product_code'] ?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-pencil font-15"></i></a>
...
<div class="col-md-12 col-sm-12 col-xs-12 m-t-20">
    ...
    <div class="row">
        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Average Purchase Rate <span class="pull-right hidden-xs">:</span></label>
        <div class="col-md-6 col-sm-6 col-xs-12">
            BDT <?php echo $productDetail[0]['avg_purchase_rate']; ?>
        </div>
    </div>
</div>
