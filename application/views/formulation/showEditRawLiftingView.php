...
<div class="col-md-12 col-sm-12 col-xs-12 p-t-20">
    <form id="rawLiftingForm" class="form-horizontal" action="<?php echo base_url() ?>Formulation/editExtraRawLifting" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                            <div class="input-group dateTxt">
                                <input type="text" name="liftingDate" id="liftingDate"  value="<?php echo $liftingSummary[0]['lifting_date'] ?>" class="form-control">
                ...
                <table id="itemDetailsTable" class="table table-bordered custom-table">
                    ...
                    foreach ($liftingDetails as $liftingDetail) {
                        ...
                        echo '<tr id="itemDetailsTr' . $applyItemCount . '">
                                    <td>' . $liftingDetail['raw_product_name'] . ' (' . $liftingDetail['raw_product'] . ')</td>
                                    <td>' . $liftingDetail['quantity'] . '</td>
                                    <td>' . $liftingDetail['raw_rate'] . '</td>
                                    <td>' . $liftingDetail['amount'] . '</td>
                                    <td><span class="text-danger pointer" onclick="removeItem(' . $applyItemCount . ')"><i class="fa fa-remove"></i></span></td>
                                    <input type="hidden" id="product' . $applyItemCount . '" name="product' . $applyItemCount . '"  value="' . $liftingDetail['raw_product'] . '">
                                    <input type="hidden" id="rate' . $applyItemCount . '" name="rate' . $applyItemCount . '"  value="' . $liftingDetail['raw_rate'] . '">
                                    <input type="hidden" id="quantity' . $applyItemCount . '" name="quantity' . $applyItemCount . '"  value="' . $liftingDetail['quantity'] . '">
                                    <input type="hidden" id="amount' . $applyItemCount . '" name="amount' . $applyItemCount . '"  value="' . $liftingDetail['amount'] . '">
                                  </tr>';
                        $applyItemCount++;
                    }
                    ?>
        ...
        <div class="row">
            <div class="col-md-5 col-sm-5 col-xs-12 col-md-offset-7 col-sm-offset-7">
                ...
                <span class="float-right" id="total"><?php echo $liftingSummary[0]['total_cost'] ?></span>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <a href="<?php echo base_url() ?>Formulation/extraRawLifting" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i> Cancel</a>
                </div>
            </div>
        </div>
        ...
        <input type="hidden" name="updatedDtTmHidden" value="<?php echo $liftingSummary[0]['updated_dt_tm'] ?>">
    </form>
</div>
