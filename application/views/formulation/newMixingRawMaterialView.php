...
<div class="col-md-12 col-sm-12 col-xs-12 p-t-20">
    <form id="mixingForm" class="form-horizontal" action="<?php echo base_url() ?>Formulation/addMixingRawMaterial" method="post">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                            <div class="input-group dateTxt">
                                <input type="text" name="mixingDate" id="mixingDate" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                            <input type="text" id="packSize" name="packSize" class="form-control col-md-7 col-xs-12" readonly="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                            <input type="text" id="finishGoodQuantity" name="finishGoodQuantity" onchange="allCalculation()" onkeyup="allCalculation()" class="form-control col-md-7 col-xs-12">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                            <input type="text" id="batchNo" name="batchNo" class="form-control col-md-7 col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                            <div class="input-group dateTxt">
                                <input type="text" name="manufactureDate" id="manufactureDate" onchange="setExpiryDate()" class="form-control">
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <input type="text" name="expiryDate" id="expiryDate" class="form-control" readonly>
                            </div>
        ...
        <div class="row">
            <div class="col-md-5 col-sm-5 col-xs-12 col-md-offset-7 col-sm-offset-7">
                ...
                <span class="float-right" id="formulationCost"></span>
                <hr>
                <span><b>Extra Cost (BDT)</b></span>
                <span class="float-right" id="extraCost"></span>
                <hr>
                <span><b>Total Cost (BDT)</b></span>
                <span class="float-right" id="total"></span>
                <hr>
                <span><b>Purchase Cost Per Unit (BDT)</b></span>
                <span class="float-right" id="perUnitPurchaseCost"></span>
                <hr>
            </div>
...
<script>
    ...
    var rawProductForFinishCount = 1;
